  ...
  <section id="container" class="">
    ...
    <section id="main-content">
      <section class="wrapper">
        <div class="row">
          <div class="col-lg-12">
            <h3 class="page-header"><i class="fa fa-file-text-o"></i> Form Edit Barang</h3>
            <ol class="breadcrumb">
          ...
          <div class="col-lg-12">
            <section class="panel">
              ...
              <!-- Letakkan scriptnya disini -->
				...
				$id = ($_GET['id']);
							$query_mysql = mysqli_query($link,"SELECT * FROM tb_barang WHERE id_barang='$id'")
							or die (mysql_error());
              ...
              <div class="panel-body">
                 <form action="simpan_edit.php" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <br>
                                <label class="col-sm-2 control-label"><span class="required">nama barang</span></label>
                                <div class="col-sm-6"> 
                                <input class="col-sm-2 form-control" name="nama_barang" value="<?php echo $data['nama_barang']?>" required="">
                                </div>
                            </div>
                            <div class="form-group">
                              </br>
                                ...
                                <div class="col-sm-3">
                                  <input class="form-control" value="<?php echo $data['harga']?>" name="harga" required="">
                                </div>  
                            </div>
                            <div class="form-group">
                              </br>
                                  <label class="col-sm-2 control-label"><span class="required">stock</span></label> 
                                <div class="col-sm-3">
                                  <input class="form-control" value="<?php echo $data['stock']?>" name="stock" required="">
                                </div>  
                            </div>
                            <br>    
                            <br>
                            <div class="form-group">
                              ...
                              <img src="<?php echo "../admin/upload/image/".$data['foto']; ?>" class="responsive-img materialboxed" align='canter' width='200' height='200'>
                              <br>
                              <br>
                                <div class="col-sm-4">
    ...
    <div class="text-right">
      <div class="credits">
          ...
          -->
          Designed by <a href="https://bootstrapmade.com/">khairul anuar</a>
        </div>
    </div>
  </section>
