          ...
          <div class="col-lg-12">
            <section class="panel">
              ...
              <!-- Letakkan scriptnya disini -->
				...
				$id = ($_GET['id']);
							$query_mysql = mysqli_query($link,"SELECT * FROM pelanggan WHERE id_pelanggan='$id'")
							or die (mysql_error());
							while ($data = mysqli_fetch_array($query_mysql)) {
				?>
              <div class="panel-body">
                 <form action="simpan_edit_pelanggan.php" method="post" ">
                                        
                                        <input type="hidden"  value="<?php echo $data['id_pelanggan']?>" name="id_pelanggan" >
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6"> 
                                            <input class="col-sm-2 form-control" name="nama_pelanggan" value="<?php echo $data['nama_pelanggan']?>" required="">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                          </br>
                                            ...
                                            <div class="col-sm-3">
                                              <input class="form-control" value="<?php echo $data['notelpon']?>" name="notelpon" required="">
                                            </div>  
                                        </div>
                                        <div class="form-group">
                                          </br>
                                            ...
                                            <div class="col-sm-3">
                                              <input class="form-control" value="<?php echo $data['alamat']?>" name="alamat" required="">
                                            </div>  
                                        </div>
                                        <br>
