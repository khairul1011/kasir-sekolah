...
function rupiah($angka){
                                   ...
                                   $hasil_rupiah = "Rp.".'&nbsp&nbsp&nbsp'. number_format($angka,0,',','.');
                                    return $hasil_rupiah;
...
$pdf->Cell(25.5,0.7,"Laporan Keseluruhan Pengiriman",0,10,'C');
$pdf->ln(1);
$pdf->SetFont('Arial','B',10);
...
$from=$_POST['from'];
$end=$_POST['end'];
$query=mysqli_query($link,"SELECT * FROM tb_platno INNER JOIN tb_pengiriman_barang ON tb_platno.id_pol=tb_pengiriman_barang.no_plat order by id_pengiriman desc");
...
$pdf->ln(1);
$pdf->SetFont('Arial','B',9);
$pdf->Cell(40.5,0.7,"__________",0,10,'C');
