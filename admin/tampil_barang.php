    ...
    <section id="main-content">
      <section class="wrapper">
        ...
        <div class="row">
                <div class="col-md-12">
                     <div class="text-left">
                         <a href="form_tambah_barang.php" class="btn btn-primary">Tambah Data Barang <i class="fa fa-arrow-circle-right"></i></a>
                         <br>
                         <br>
                     </div>
                 </div>
...
<!-- Tambahkan dibawah ini script tampil data BARANG -->
                                ...
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tbody>
                                      ...
                                      <tr class="odd gradeX tabel1" align="center">
                                            ...
                                            <td>
                                              <a href="edit_barang.php?id=<?php echo $data['id_barang']; ?>">
                                              <button class="btn btn-success "><i class= "icon_cogs"></i>Edit</button>
                                              </a>
                                            </td>
    ...
    <div class="text-right">
      <div class="credits">
          ...
          -->
          Designed by <a href="https://bootstrapmade.com/">Ilham Fitra</a>
        </div>
    </div>
  </section>
